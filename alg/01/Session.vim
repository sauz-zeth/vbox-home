...
wincmd w
argglobal
if bufexists("Уроки_программирования.md") | buffer Уроки_программирования.md | else | edit Уроки_программирования.md | endif
balt data1.txt
lnoremap <buffer> " Э
lnoremap <buffer> # №
lnoremap <buffer> $ ;
...
wincmd w
argglobal
if bufexists("data1.txt") | buffer data1.txt | else | edit data1.txt | endif
balt Уроки_программирования.md
lnoremap <buffer> " Э
lnoremap <buffer> # №
lnoremap <buffer> $ ;
lnoremap <buffer> & ?
...
badd +0 alg01.c
badd +0 data1.txt
badd +0 Уроки_программирования.md
